...
if ($action === 'view_photo') {
    ...
    echo '<a href="outputs/' . $filename . '" class="btn" download="MiFotoConTono.jpg" target="_blank">';
...
if ($action === 'download_image') {
    ...
    if ($filename && file_exists($filepath)) {
        ...
        if ($isBrowser) {
            ...
            echo '<h1>¡TU FOTO LISTA!</h1>';
            echo '<p>Guarda este recuerdo de tu encuentro con Toño Martín del Campo.</p>';
            echo '<a href="outputs/' . urlencode($filename) . '" class="btn" download="MiFotoConTono.jpg" target="_blank">DESCARGAR FOTO</a>';
            echo '</div></body></html>';
        } else {
